...
public class GUIAnalysis {
  ...
  /**
   * Populate ID containers with information from XML files, and print out some statistics as a sanity
   * check. The ID containers are used in the construction of flowgraph.
   */
  public void populateIDContainers() {
    ...
    System.out.println("[XML] Layout Ids: " + allLayoutIds.size() + ", Menu Ids: " + allMenuIds.size() + ", Widget Ids: " + allWidgetIds.size() + ", String Ids: " + allStringIds.size());
