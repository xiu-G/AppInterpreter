...
public class DefaultGUIAnalysisOutput implements GUIAnalysisOutput {
	...
	/*
	 * Given a dialog, what are the triggering statements. For example, dialog.show(), builder.show(),
	 * activity.showDialog(...).
	 */
	@Override
	...
	/*
	 * Given a statement, returns the set of dialogs it can trigger. If none, an empty set is returned.
	 */
	@Override
	...
	/*
	 * dialog.dimiss(), dialog.cancel(), activity.dismissDialog(), activity.removeDialog().
	 */
	@Override
	...
	List<String> menuHandlerSubsigs = Lists.newArrayList(MethodNames.onContextItemSelectedSubSig, MethodNames.onOptionsItemSelectedSubSig, MethodNames.onMenuItemSelectedSubSig);
	...
	List<String> menuCreationHandlerSubSigs = Lists.newArrayList(MethodNames.onCreateOptionsMenuSubsig, MethodNames.onPrepareOptionsMenuSubsig);
	...
	List<String> activityLifecycleHandlerSubsigs = Lists.newArrayList(MethodNames.onActivityCreateSubSig, MethodNames.onActivityDestroySubSig, MethodNames.onActivityPauseSubSig, MethodNames.onActivityRestartSubSig, MethodNames.onActivityResumeSubSig, MethodNames.onActivityStartSubSig, MethodNames.onActivityStopSubSig, MethodNames.activityOnNewIntentSubSig);

	List<String> optionsMenuLifecycleHandlerSubsigs = Lists.newArrayList(MethodNames.onCreateOptionsMenuSubsig, MethodNames.onPrepareOptionsMenuSubsig, MethodNames.onCloseOptionsMenuSubsig);

	List<String> contextMenuLifecycleHandlerSubsigs = Lists.newArrayList(MethodNames.onCreateContextMenuSubSig, MethodNames.onCloseContextMenuSubsig);

	List<String> dialogLifecycleMethodSubSigs = Lists.newArrayList(MethodNames.onDialogCreateSubSig, MethodNames.onDialogStartSubSig, MethodNames.onDialogStopSubSig);
	...
	List<String> dialogCreationHandlerSubsigs = Lists.newArrayList(MethodNames.activityOnCreateDialogSubSig, MethodNames.activityOnCreateDialogBundleSubSig, MethodNames.activityOnPrepareDialogSubSig, MethodNames.activityOnPrepareDialogBundleSubSig);
	...
	// handlers.
	public Map<EventType, Set<SootMethod>> getSupportedEventsAndTheirHandlers(NObjectNode guiObject, Predicate<EventType> condition) {
	...
	/*
	 * Given a statement, return a set of menus that can be triggered by this statement. Typically
	 * examples: view.showContextMenu(), activity.openContextMenu(view), activity.openOptionsMenu().
	 */
	@Override
